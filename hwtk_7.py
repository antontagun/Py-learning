...
cart1_true = ['Москва', 'Лондон', 'Вашингтон']
cart2_true = ['Германия', 'Франция']
...
def solution(cart1, cart2, label_4, cart1_true, cart2_true):
    t1 = None
    t2 = None
    ...
    if t1 == True and t2 == True:
        label_4['bg'] = 'lightgreen'
        label_4['text'] = 'Правельно'
    elif (t1 == False and t2 == True) or (t1 == True and t2 == False) or (t1 == False and t2 == False):
        label_4['bg'] = 'red'
        label_4['text'] = 'Не правельно'
frame_1 = Frame()
...
bt_6 = Button(frame_3, bg='lightgreen', text='Проверить', command=lambda i = cart1, j = cart2, n = label_4,
    m = cart1_true, h = cart2_true: solution(i, j, n, m , h))
bt_5.grid(row=2, column=3)
bt_6.grid(row=1, column=3)
mainloop()